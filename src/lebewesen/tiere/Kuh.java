...
public class Kuh extends Lebewesen implements GrundBeduerfnisse {
    ...
    public boolean suchePartner() {
        ...
        Kuh k2 = null;
        if (getGeschlecht() == 0) {
            k = (Kuh) HilfsKlassen.isInRadiusUnit(this, getPosition(),
                    getSichtWeite(), 1, false, 100);
            k2 = (Kuh) HilfsKlassen.isInRadiusUnit(this, getPosition(), 0, 1,
                    false, 100);
        } else {
            k = (Kuh) HilfsKlassen.isInRadiusUnit(this, getPosition(),
                    getSichtWeite(), 0, false, 100);
            k2 = (Kuh) HilfsKlassen.isInRadiusUnit(this, getPosition(), 0, 0,
                    false, 100);
        }
        if (k != null) {
            if (k != k2) {
